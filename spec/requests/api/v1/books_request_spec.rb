...
describe "Books API" do
   ...
   it "can create a new book" do
      book_params = ({
                     ...
                     genre: 'mystery',
                     summary: 'A mystery book about murder on the orient express',
                     number_sold: 432
      })

      headers = { 'Content-Type' => 'application/json' }

      #include this header to make sure that these params are passed as JSON rather than as plain text
   ...
   it 'can update an existing book' do
      ...
      # we need to include this header to make sure that these params are passed as JSON rather than as plain text
